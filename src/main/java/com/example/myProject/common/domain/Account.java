...
public class Account {
    ...
    public boolean transfer(String receivingBank, String receivingAccountNumber, String receivingAccountHolder, long amount) {
        if(this.balance < amount) {
            System.out.println("Insufficient balance for transfer." +" Current balance: " + this.balance + " Transfer amount: " + amount);
            return false;
        }

        this.balance -= amount;
        addTransaction(FinancialAction.TRANSFER, amount);
        System.out.println("Transfer: " + amount + " Current balance: " + this.balance + " Receiving bank: " + receivingBank + " Receiving account number: " + receivingAccountNumber + " Receiving account holder: " + receivingAccountHolder);
        return true;
    }
